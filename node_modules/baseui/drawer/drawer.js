...
var Drawer = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Drawer, [{
    ...
    value: function renderDrawer(renderedContent) {
      ...
      var _getOverrides = (0, _overrides.getOverrides)(RootOverride, _styledComponents.StyledRoot),
          _getOverrides2 = _slicedToArray(_getOverrides, 2),
          Root = _getOverrides2[0],
          rootProps = _getOverrides2[1];

      var _getOverrides3 = (0, _overrides.getOverrides)(BackdropOverride, _styledComponents.StyledBackdrop),
          _getOverrides4 = _slicedToArray(_getOverrides3, 2),
          Backdrop = _getOverrides4[0],
          backdropProps = _getOverrides4[1];

      var _getOverrides5 = (0, _overrides.getOverrides)(DrawerContainerOverride, _styledComponents.StyledDrawerContainer),
          _getOverrides6 = _slicedToArray(_getOverrides5, 2),
          DrawerContainer = _getOverrides6[0],
          drawerContainerProps = _getOverrides6[1];

      var _getOverrides7 = (0, _overrides.getOverrides)(DrawerBodyOverride, _styledComponents.StyledDrawerBody),
          _getOverrides8 = _slicedToArray(_getOverrides7, 2),
          DrawerBody = _getOverrides8[0],
          drawerBodyProps = _getOverrides8[1];

      var _getOverrides9 = (0, _overrides.getOverrides)(CloseOverride, _styledComponents.StyledClose),
    ...
    value: function render() {
      ...
      if (renderedContent) {
        if (mountedAndOpen) {
          return /*#__PURE__*/React.createElement(_index2.Layer, {
