...
function DatetimeFilter(props) {
  ...
  const [categoricalOperator, setCategoricalOperator] = React.useState([initialState.categoricalOperator]); // flowlint-next-line unclear-type:off
  ...
  return /*#__PURE__*/React.createElement(FilterShell, {
    ...
    value: rangeOperator,
    onChange: params => setRangeOperator(params.value) // flowlint-next-line unclear-type:off
    ,
  ...
  }, (rangeOperator[0].id === DATETIME_OPERATIONS.RANGE_DATETIME || rangeOperator[0].id === DATETIME_OPERATIONS.RANGE_DATE) && /*#__PURE__*/React.createElement(Datepicker // flowlint-next-line unclear-type:off
  , {
    mountNode: mountNode.current,
    value: rangeDates,
    onChange: ({
