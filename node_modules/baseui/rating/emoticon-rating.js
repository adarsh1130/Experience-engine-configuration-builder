...
var EmoticonRating = /*#__PURE__*/function (_React$Component) {
  ...
  function EmoticonRating() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderRatingContents", function () {
      ...
      var _getOverrides = (0, _overrides.getOverrides)(overrides.Item, _styledComponents.StyledEmoticon),
      ...
      var _loop = function _loop(x) {
        ...
        ratings.push( /*#__PURE__*/React.createElement(Emoticon, _extends({
          key: x,
          role: "radio" // flowlint-next-line unclear-type:off
          ,
          ref: starRef,
          ...
          onFocus: (0, _focusVisible.forkFocus)(emoticonProps, _this.handleFocus),
          onBlur: (0, _focusVisible.forkBlur)(emoticonProps, _this.handleBlur)
        }, emoticonProps)));
      };
